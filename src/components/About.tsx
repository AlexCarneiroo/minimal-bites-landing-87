...
const About = () => {
  ...
  const description =
    ...
    "A Sabor Express nasceu da paixão por comida de qualidade e do desejo de oferecer lanches artesanais feitos com ingredientes frescos e selecionados. Desde 2010, nosso compromisso é proporcionar uma experiência única, com um ambiente acolhedor e um atendimento que faz você se sentir em casa.";
  ...
  const address =
    establishmentData?.address || "Rua das Delicias, 123 - Centro - São Paulo";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 mt-16 md:mt-0">
            <p className="text-snackbar-gray mb-6">{description}</p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-snackbar-dark mb-1">
